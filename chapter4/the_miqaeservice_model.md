...
The spawned Automation Method must access the Service Model (MiqAeService*) objects that reside in the Automation Engine process, and it does this using Distributed Ruby.
...
#### Footnote: Examining CloudForms Workers
